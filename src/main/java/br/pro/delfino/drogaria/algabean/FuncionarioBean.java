...
public class FuncionarioBean implements Serializable {
	...
	private static final String[] nomes = { "João", "maria", "Eduardo", "Sebastião", "mariana", "Francisco", "Manoel",
			"Fernando", "Gabriela", "Mario", "marcos" };
	private static final String[] sobrenomes = { "Souza", "Silva", "Andrade", "machado", "Junior", "Albuquerque",
